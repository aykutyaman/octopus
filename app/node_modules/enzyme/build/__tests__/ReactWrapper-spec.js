...
(0, _.describeWithDOM)('mount', function () {
    ...
    it('should call componentWillReceiveProps for new renders', function () {
      ...
      var Foo = function (_React$Component5) {
        ...
        function Foo(props) {
          ...
          var _this5 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));

          _this5.componentWillReceiveProps = spy;
          return _this5;
        }
  ...
  describe('.simulate(eventName, data)', function () {
    ...
    it('should simulate events', function () {
      var Foo = function (_React$Component7) {
        ...
        function Foo(props) {
          ...
          var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));

          _this7.state = { count: 0 };
          _this7.incrementCount = _this7.incrementCount.bind(_this7);
          return _this7;
        }
    ...
    it('should throw a descriptive error for invalid events', function () {
      var wrapper = (0, _.mount)(_react2.default.createElement(
        'div',
        null,
        'foo'
      ));
      (0, _chai.expect)(wrapper.simulate.bind(wrapper, 'invalidEvent')).to['throw'](TypeError, "ReactWrapper::simulate() event 'invalidEvent' does not exist");
    });
  ...
  describe('.setState(newState)', function () {
    ...
    it('allows setState inside of componentDidMount', function () {
      ...
      var MySharona = function (_React$Component12) {
        _inherits(MySharona, _React$Component12);

        function MySharona(props) {
          _classCallCheck(this, MySharona);

          var _this12 = _possibleConstructorReturn(this, Object.getPrototypeOf(MySharona).call(this, props));

          _this12.state = { mounted: false };
          return _this12;
        }
    ...
    it('should return the current state after state transitions', function () {
      var Foo = function (_React$Component16) {
        ...
        function Foo(props) {
          ...
          var _this16 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));
    ...
    it('should allow a state property name be passed in as an argument', function () {
      var Foo = function (_React$Component17) {
        ...
        function Foo(props) {
          ...
          var _this17 = _possibleConstructorReturn(this, Object.getPrototypeOf(Foo).call(this, props));

          _this17.state = { foo: 'foo' };
          return _this17;
        }
  ...
  describe('.html()', function () {
    ...
    it('should render out nested composite components', function () {
      ...
      var Bar = function (_React$Component21) {
        _inherits(Bar, _React$Component21);
      ...
      var wrapper = (0, _.mount)(_react2.default.createElement(Bar, null));
